-- 0013_sync_order_rpc_orphan_cleanup.sql
-- Updates sync_order_to_mirror RPC to clear out deleted items (orphans) 
-- that are no longer part of the updated order payload.
...
BEGIN
  ...
  -- Guard：p_items 非空才執行，避免空陣列刪除所有 items
