-- Migration 0090（原編號 0087，2026-08-04 apply 至 live Supabase，但當時 commit 未 merge 入
-- main，直至 D66-follow 2026-08-20 補 merge 時因與另一 0087（D62 sync_order_to_mirror）撞號
-- 而改名 0090；本檔內容與 live 已跑 DDL 完全一致，重新編號不影響 live，Supabase 用 timestamp
-- 版本非檔名數字前綴——見 .fhs/memory/lessons/2026-07-13_worktree-branch-mismatch-migration-number-collision.md）：
-- 修復 message_intents 冪等鍵誤含 alert_date（2026-08-04 IG 看門狗 P2c 稽核發現）
