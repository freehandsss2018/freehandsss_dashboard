# FHS 系統架構藍圖 (FHS System Blueprint) - V4.2
> 💡 **【給 Fat Mo 的文件定位說明】**
...
---
#### D. Global Review Center (全域核對中心) [V27 優化]
...
- **維度矩陣化顯示 (Detailed Product Grid)**：`Product Items` 欄位強制採用結構化「膠囊標籤 (Badge)」陣列顯示。
  - **對象**: 嬰兒、大寶、父母 (嚴格區分)
  - **類別**: 🔑 鎖匙扣、💍 吊飾、🎨 3D擺設
  - **部位**: 左手、右手、左腳、右腳
  - **材質**: ⚙️ 不銹鋼、✨ 925銀、👑 925金
- **刻字水平佈局**：刻字欄位 (Engraving) 強制採用【上排】【下排】平行佈局，明確區分上下文字。
- **行內快速編輯 (Inline Edit)**：
