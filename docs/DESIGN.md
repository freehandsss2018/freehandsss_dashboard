...
Freehandsss 定位為「嬰兒手足立體石膏倒模紀念品工作室」，將傳統手工溫度與現代 3D 鑄造技術完美結合。因此，系統視覺不應採用冷冰冰的科技藍白，而是採用溫潤的大地沙土與暖橘色系，營造「數字珠寶坊 (Digital Atelier)」的高奢手作質感，讓使用者（Mobile phone 介面及 Desktop 介面使用者）在操作時感受到品牌的工匠精神。
