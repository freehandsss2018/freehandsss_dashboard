...
更新日期：2026-07-05（補與 /fhs-slim 分界註記；上次更新 2026-05-17 新增檢查七：語義稽核 — D1-D5 五維深度檢測）

> **與 `/fhs-slim` 分界**（2026-07-05，S142 新增）：本指令為重量級按需深稽核（S145 2026-07-05 實測逐條展開為 33 項，A1-A7 共 7 大檢查；「30 項」為早期版本統計，見 `.fhs/reports/audits/system/audit_2026-07-05.md` 文末附註）。
> 若只需日常文件健康快檢（過肥/沉積孤兒/過時漂移/同名重複/歸檔斷鏈），
> 那五項已由 `scripts/hooks/fhs-health-check.js`（L1，每次 SessionStart 自動偵測）+
