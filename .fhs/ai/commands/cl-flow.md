...
**品質底線（2026-07-07，[來源: obra/superpowers writing-plans]）**：第 6 節「最終執行計劃」禁止出現佔位語句——「TBD」「加適當錯誤處理」「同上一步驟」「細節待定」視為計畫失敗，須重寫到可執行為止。硬約束（AGENTS.md 相關條款）逐字抄入第 5/6 節，不用「見上方規則」帶過。
