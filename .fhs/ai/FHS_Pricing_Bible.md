...
> **Version**: v1.5.0
> **更新日期**: 2026-07-21 (§2.1 修復肢數判定 bug：hasFoot 捷徑判斷→實際總肢數計算，並將大寶肢體納入嬰兒同等計數但不觸發家庭價；2026-07-19 §2.1 玻璃瓶套裝新增「含父母」家庭定價 $2,580 並改用獨立 SKU「玻璃瓶套裝 (家庭)」（推翻同日較早嘅「SKU不變」決定，修正稽核面板顯示舊價 bug）；§6 footnote 修正已過時技術債描述)
