...
| [[02_model-dispatch]] | 模型調度守則：指揮官不下場、派工三件套、model 對照表、升降級、驗證不自驗 | v1.0.1 | ✅ 2026-07-04（含對抗審查修正）|
| [[03_judgment-rubrics]] | 判斷力外化：升級/完成/問人/換路/品質底線 五組 rubric，每條附正反例 | v1.0.0 | ✅ 2026-07-04 |
