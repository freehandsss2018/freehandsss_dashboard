...
| [[02_model-dispatch]] | 模型調度守則：指揮官不下場、派工三件套、model 對照表、升降級、驗證不自驗 | v1.0.6 | ✅ 2026-08-29（D88 §7 追加「稽核 checklist 與來源規則文件漏同步」教訓；前 v1.0.5 2026-07-21 S183續 並行worktree視野盲區教訓+session-start-sop.sh機制層防護）|
