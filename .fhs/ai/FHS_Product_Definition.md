...
例：木框套裝 (4肢)、玻璃瓶套裝 (2肢)
```
例外一：玻璃瓶套裝若倒模對象含**父母**，SKU 改為「玻璃瓶套裝 (家庭)」（不再標肢數，因售價 flat 不分 2肢/4肢，2026-07-19 新增，見 `FHS_Pricing_Bible.md §2.1`）。
例外二：玻璃瓶套裝若該件**有大寶參與且無父母**，SKU 改為「玻璃瓶套裝 (2肢+大寶/4肢+大寶)」，售價 $1,680／$1,980（2026-08-22 新增，migration 0091，見 `FHS_Pricing_Bible.md §2.1`）。肢數 tier **只數嬰兒肢體**，大寶只以「有冇參與」做 ＋$300 修正項，不影響 2肢/4肢 分級。
兩個例外互斥且父母優先：含父母一律走 `(家庭)`，不論有無大寶。木框套裝無大寶/父母 UI 選項，故無對應變體。

> **「嬰兒」與「大寶」的定義**（2026-08-22 Fat Mo 口述成文）：嬰兒＝初生或客人**首個**孩子；大寶＝客人**第二個**孩子（嬰兒的兄／姊）。「大寶」是相對於「嬰兒」的稱謂，故**有大寶必然有嬰兒**——「只有大寶、沒有嬰兒」在定義上不成立（該孩子本身就會被定義為嬰兒）。此定義是上述定價分級的根基，全文見 `FHS_Pricing_Bible.md` §0。
