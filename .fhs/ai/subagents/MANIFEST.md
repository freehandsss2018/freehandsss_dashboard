...
| database-reviewer | 2.2.1 | 2026-08-16 | accessory_cost 第四成本分類補漏（羊毛氈/燈飾配件，migration 0079/0080），commit b6db6cd——本次補記：frontmatter 早已升版但本表漏同步，屬 dual-write drift（agent_dashboardV42.js 勘誤揪出）|
| finance-auditor | 2.2.1 | 2026-08-16 | 同上 accessory_cost 補漏，同一 commit b6db6cd，同一漂移補記 |
