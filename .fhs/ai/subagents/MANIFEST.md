...
| finance-auditor | 2.3.0 | 繼承主對話（frontmatter 無 model:） | active | `~/.claude/agents/freehandsss/finance-auditor.md` | FHS native（四端財務稽核員） |
...
| finance-auditor | 2.3.0 | 2026-09-19 | 0600804 事故方案C-C5：tools 補 Supabase `execute_sql`/`list_tables`（只准 SELECT）、Airtable 工具改現行名、description 改 MUST BE USED PROACTIVELY、新增模式 B 財務規則解答；master＋`~/.claude/agents/` 雙寫 |
