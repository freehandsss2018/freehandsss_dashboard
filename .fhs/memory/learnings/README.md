...
| 桶 | 檔案 | 範圍 | 目前條數 | 配額上限 |
|---|---|---|---|---|
| Supabase | [supabase.md](supabase.md) | Postgres / PostgREST / RLS / migration / RPC 權限 | 12 | 20 |
| Frontend | [frontend.md](frontend.md) | 主應用前端 HTML/JS（表單、渲染、狀態管理） | 14 | 25 |
| Finance | [finance.md](finance.md) | 定價 / 成本 / SKU / 財務計算規則 | 5 | 20 |
| n8n | [n8n.md](n8n.md) | Workflow 節點、payload、API 限制 | 7 | 20 |
| Governance | [governance.md](governance.md) | 治理制度、多代理協作、文件生命週期 | 7 | 15 |
| Tooling | [tooling.md](tooling.md) | 開發工具、第三方整合、harness 怪癖 | 5 | 15 |
| **合計** | — | — | **50 主文 + 8 個跨桶指標** | **115** |
