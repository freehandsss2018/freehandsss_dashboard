```handoff
【FHS 交接摘要 — 更新: 2026-07-02 / S131】
🎯 目標: FHS 業務 POS+財務系統日常維護；S131 修正簡化付款 auto-fill 後「全部半訂」按鈕未切換至「全部付清」bug；下一步=/upload-web 部署 S131 至 NAS
