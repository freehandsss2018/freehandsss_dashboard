...
➡️ 下一步: 🔴優先 — Fat Mo手動resync 0600107（D41）+ DebbieHo(0600727)（D40）兩張歷史單；task_0811eb3c訂單載入產品勾選殘留bug待Fat Mo決定是否派工修復；Fat Mo批S149/S155/取模排程C+D+E之一，或評估S180`globalOrders`limit:200 fallback；**worktree並行部署教訓**：日後多個worktree同時改Dashboard HTML時，先merge落main再部署
