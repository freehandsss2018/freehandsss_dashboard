```handoff
【FHS 交接摘要 — 更新: 2026-07-22 / S187續VIII（D43：Airtable全面剝離停用，Supabase正式翻轉唯一SSoT；6個n8n workflow+Dashboard前端已改駁；順手修復5個獨立pre-existing bug；fresh-context opus驗收全PASS；S187續VIII：財務結算卡片報價排版斷行修復）】
