...
✅ 已定決策（(1)-(44)為S115-S160歷史決策，內容分散收錄於decisions.md/下方MASTER表/governance/03/FHS_System_Logic_Overview.md/learnings.md等既有文件，不重複列出；5項D9標記高風險規則—PUT四欄/qty禁假乘法/contentType raw/ensure_ascii/cost_override_locked—已個別核實仍可查，見對應文件）：近期活躍：(45)3D打印v0方案：分期先腳後手、腳固定30.5mm、手尺寸讀檔名禁推算、掛環=Ring-24545.obj只擺位禁縮放、環+刻字為mm常數縮放後才加(S161)；(46)完成偵測納鎖匙扣/吊飾4情境，羊毛氈/燈飾豁免(S161續)；(47)桌面補退回進行中按鈕(S161續)；(48)完成偵測移除手模擺設前提，三類至少一種即適用(S161續III)；(49)訂單總覽五項UI/UX修復(S162)；(50)S149治理可攜化§5重審：前置閘已滿足，驗收改當日基線(S165)；(51)3D打印v0降級為師傅版模式：AI只做縮放+刻字+加環+QC，紋理留師傅(S166)
