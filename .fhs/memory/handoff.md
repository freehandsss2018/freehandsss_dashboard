...
📋 待辦: 🟡[D43]system_config.last_id暫存保守預設值06000，需Fat Mo設定面板核實/更正 🟡[D43]Financial Aggregator未對齊3-layer revenue fallback RPC，列技術債非緊急 🟢[舊D42]Airtable阻塞已移除，可隨時補做test9002式端對端測試確認V47.20（非緊急，收尾性質） 🟡[S182]iOS月曆重疊待實機覆核 🔴[S161/S166]3D打印Phase1待簽收 🔴[S155]YouTube+NFC計畫待批 🔴[S149]治理可攜化待批准
➡️ 下一步: Fat Mo 核實 system_config 下一個訂單序號正確值（06000係保守預設，非查證原值）；其餘技術債非緊急
...
> 上次更新：2026-07-22（D43：Airtable全面剝離停用，Supabase正式翻轉唯一SSoT，詳見下表[D43]列；下方兩條舊 Airtable 額度🔴項因剝離而解決，改列✅）
