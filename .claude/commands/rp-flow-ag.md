---
description: /rp精煉自動串聯A1 PX研究+A2 ag-plan，ag-plan為裁決文件，跳過A3 Claude Verdict (Claude Code Bridge)
---

# /rp-flow-ag (Claude Code Bridge)
...
3. Step 2：自動接 A1 PX 研究 → A2 ag-plan（ag-plan 為最終裁決文件）
4. Step 3：plan_critique（3點批評，針對 ag-plan 本身）
...
- ✅ plan_critique 必須針對 ag-plan 真實缺陷，禁止套模板
- ✅ A3 Claude Verdict 不執行
