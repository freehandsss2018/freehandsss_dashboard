...
// {{ENV_PREFIX}}_HEALTH_ROOT pointed at the sandbox and {{ENV_PREFIX}}_HEALTH_REPORT_OUT/
// {{ENV_PREFIX}}_HEALTH_ERROR_LOG redirected to a scratch dir so fixtures never
...
const SCRATCH_DIR = fs.mkdtempSync(path.join(os.tmpdir(), 'portable-health-'));
...
for (const fx of manifest) {
  ...
  const env = Object.assign({}, process.env, {
    '{{ENV_PREFIX}}_HEALTH_ROOT': fixtureDir,
    '{{ENV_PREFIX}}_HEALTH_RULES': resolvedRulesPath,
    '{{ENV_PREFIX}}_HEALTH_REPORT_OUT': reportPath,
    '{{ENV_PREFIX}}_HEALTH_ERROR_LOG': errorLogPath
  });
